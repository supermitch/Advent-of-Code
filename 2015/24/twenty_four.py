...
def find_arrangements_four(weights):
    ...
    for n1 in range(1, n - 2):
        for n2 in range(1, n - n1 - 1):
            for n3 in range(1, n - n1 - n2 - 1):
                n4 = n - n1 - n2 - n3
                print('n: {}, {}, {}, {}'.format(n1, n2, n3, n4))

                sizes = tuple(sorted([n1, n2, n3, n4]))
                if sizes in seen:  # No repeat sizes, e.g. 2,2,4 = 2,4,2 = 4,2,2
                    continue
                seen.add(sizes)
                ...
                for g1 in combinations(weights, n1):
                    ...
                    for g2 in combinations(g2_weights, n2):
                        ...
                        g3_weights = g2_weights - set(g2)
                        for g3 in combinations(g3_weights, n3):
                            if sum(g3) != target:
                                continue
                            ...
                            if n1 < n2 and n1 < n3 and n1 < n4:
                                ...
                                g4 = g3_weights - set(g3)
                                entanglement = product(g4)
                                if entanglement < lowest_entanglement:
                                    lowest_entanglement = entanglement
...
def main():
    ...
    lowest_entanglement = find_arrangements_four(weights)
    print(lowest_entanglement)
